"""
SHORT Strategy: Reversal After Historical High
Вход при развороте после достижения нового максимума
"""
import sys
import os
...
TP_RR_VALUES = [2.0, 3.0, 4.0, 5.5]
ATR_PERIOD = 14
ATR_BUFFER = 0.5
START_DATE = "2020-01-01"
END_DATE = "2026-04-18"

# Lookback for historical high
LOOKBACK_H4_BARS = 20
...
def run_backtest(df, df_h4, risk_per_trade, tp_rr):
    ...
    for date_idx, date in enumerate(unique_dates):
        ...
        for i in range(len(day_data)):
            ...
            if len(h4_bars) < LOOKBACK_H4_BARS + 2:
                continue
...
def main():
    print("=== SHORT Reversal After Historical High Strategy ===")
