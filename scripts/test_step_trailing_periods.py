"""
Test Step Trailing on two periods separately
"""
import sys
import os
...
print("Loading full data 2020-2026...")
sys.stdout.flush()
...
# Period 1: 2020-2023
df_p1 = df_full[df_full.index < '2024-01-01']
df_h4_p1 = df_h4_full[df_h4_full.index < '2024-01-01']
run_period(df_p1, df_h4_p1, "PERIOD 1: 2020-2023 (Risk=$190, TP=5.5, Step Trailing)")

# Period 2: 2024-2026
df_p2 = df_full[df_full.index >= '2024-01-01']
df_h4_p2 = df_h4_full[df_h4_full.index >= '2024-01-01']
run_period(df_p2, df_h4_p2, "PERIOD 2: 2024-2026 (Risk=$190, TP=5.5, Step Trailing)")
