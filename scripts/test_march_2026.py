"""
Test March 2026 only - single month analysis
"""
import sys
import os
...
print("Testing March-April 2026")
print("="*80)
sys.stdout.flush()
...
df = df_full[(df_full.index >= '2026-03-01') & (df_full.index <= '2026-04-20')]
...
print(f"Loaded {len(df)} M15 bars for March-April 2026")
sys.stdout.flush()
...
if len(trades) == 0:
    print("No trades in March-April 2026")
    sys.exit(0)
...
for idx, trade in trades_df.iterrows():
    ...
    print(f"  {trade['range_type'].upper()}: ${trade['pnl']:,.2f} ({result})")
