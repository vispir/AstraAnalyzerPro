...
LONG: из коммита e77adbe (ATR=20, range фильтры)
SHORT: текущий short_reversal_v1.py (ATR=14)
"""
import sys
import os
...
print("="*80)
print("КОМБИНИРОВАННЫЙ: LONG (e77adbe) + SHORT (текущий)")
print("="*80)
...
df['atr_long'] = calculate_atr(df, LONG_ATR_PERIOD)
df['atr_short'] = calculate_atr(df, SHORT_ATR_PERIOD)
