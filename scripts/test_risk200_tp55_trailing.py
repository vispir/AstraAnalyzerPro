"""
Test Risk=$200, TP=5.5, WITH Step Trailing
Best of both worlds: high risk + trailing protection
"""
import sys
import os
...
print("Testing Risk=$200, TP=5.5, WITH Step Trailing")
print("="*80)
sys.stdout.flush()
...
print(f"\nRESULTS: Risk=$200, TP=5.5, WITH Step Trailing")
print("="*80)
...
print("="*80)
print("\nCOMPARISON:")
print("Risk=$200, TP=5.5, NO trailing:   $62,248, DD=9.72%, WR=~35%")
print("Risk=$190, TP=5.5, WITH trailing: $48,263, DD=6.99%, WR=50.8%")
print(f"Risk=$200, TP=5.5, WITH trailing: ${total_pnl:,.0f}, DD={max_dd:.2f}%, WR={win_rate:.1%}")
print("="*80)
sys.stdout.flush()
