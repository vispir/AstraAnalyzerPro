"""
Combined Strategy WITHOUT NY Session:
LONG: только Asian (7-10) и London (13-16), simple windows, ATR=14
SHORT: без изменений
"""
import sys
import os
...
print("="*80)
print("COMBINED: LONG (Asian + London only) + SHORT")
print("="*80)
