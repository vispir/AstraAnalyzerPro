...
TRAIL_TRIGGER_RR = 999.0           # disable trailing (set to unreachable value)
TRAIL_DISTANCE_ATR = 0.8         # trail by 0.8 ATR (testing wider)
...
RANGE_BREAKOUT_V1_TRAIL_DISTANCE_ATR = 0.3  # trailing stop distance (testing tighter)
...
RANGE_BREAKOUT_V1_MIN_BARS_INSIDE_PCT = 0.70  # min 70% bars closed inside range
